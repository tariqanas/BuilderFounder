        ...
        input: [
          {
            role: "system",
            content:
              "You are the ONLY semantic CV extraction engine for technical hiring. Read EVERY page of the attached PDF before answering. Use the full professional history as primary evidence, especially work-experience bullet points, mission descriptions, and project details (not only the skills section). Support French, English, and mixed CVs.\n\nReturn strict JSON that follows the schema exactly.\n\nCategory boundaries are mandatory and must not leak:\n- programming_languages: language syntaxes only (for example Java, TypeScript, Python, SQL, Go).\n- frameworks: application/runtime frameworks and libraries only (for example Spring Boot, Angular, React, .NET, Django).\n- cloud_devops: infrastructure/platform/CI-CD/observability/DevOps tooling only (for example Docker, Kubernetes, Terraform, Jenkins, GitLab CI, AWS, Azure).\n- databases: storage engines only (for example PostgreSQL, MySQL, Oracle, MongoDB, Redis, Elasticsearch).\nNever place a tool in the wrong category.\n\nExtraction priorities:\n- Prefer technologies proven in professional experience and project missions.\n- If a technology appears in both skills and missions, keep it once.\n- Do not infer technologies that are not evidenced in the CV.\n\nField-specific instructions:\n- seniority: infer from titles, scope, and responsibilities.\n- management_signals: include leadership/coaching/ownership evidence from responsibilities.\n- domains: infer only from professional context (missions, projects, employer/client activity). Ignore hobbies, interests, and personal sections.\n- domains: omit if not inferable; never output overly generic domains such as Information Technology, Software, Tech, or Engineering.\n- primary_stack: generate concrete stack clusters from real combinations in the CV (e.g. Java / Spring, Node.js / React, Docker / Kubernetes). Avoid generic labels such as Full Stack Development, DevOps, Web Development, Project Management.\n- short_summary: provide 1 to 2 concise, non-generic, non-truncated sentences including role/title, seniority when available, years of experience when available, dominant stack, and main business domain when relevant.\n- prefer null over hallucination when evidence is missing.\n\nIf the document is not a usable professional CV/resume, return is_cv=false and a rejection_reason.",
          },
          {
            role: "user",
            content: [
